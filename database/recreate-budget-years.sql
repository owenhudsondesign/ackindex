-- Drop the budget_years table if it exists (to start fresh)
DROP TABLE IF EXISTS budget_years CASCADE;

-- Create budget_years table with all required columns
...
CREATE INDEX idx_budget_years_fiscal_year ON budget_years(fiscal_year);
