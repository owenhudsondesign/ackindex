                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      Peak usage times, most viewed meetings, trending topics
                    </p>
                  </div>
                </div>
                <a
                  href="/admin/analytics"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-all duration-200 font-medium text-sm shadow-sm hover:shadow-md"
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      Monitor scraping and embedding job queues
                    </p>
                  </div>
                </div>
                <a
