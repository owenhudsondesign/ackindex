...
export default function AudioUploader() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsUploading(true);
    setStatus({ type: 'processing', message: 'Uploading and processing audio file...' });
    ...
    try {
      ...
      setStatus({
        type: 'success',
        message: `✅ Processing started! Document ID: ${data.documentId}. This may take 15-30 minutes.`,
      });
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Upload audio files for videos over 120 minutes (AssemblyAI)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
        ...
        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <li className="flex items-start gap-2">
            ...
            <span>Use for videos longer than 120 minutes (Gladia limit)</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-purple-600 dark:text-purple-400 mt-0.5">2.</span>
            <span>Download audio using ytmp3.nu or similar service</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-purple-600 dark:text-purple-400 mt-0.5">3.</span>
            <span>Upload here with the YouTube video ID</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-purple-600 dark:text-purple-400 mt-0.5">4.</span>
            <span>Processing takes ~15-30% of audio duration (automated via AssemblyAI)</span>
          </li>
        </ul>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            ...
            See <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">LONG_VIDEO_QUICKSTART.md</code> for detailed workflow.
          </p>
        </div>
      </div>
    </Card>
