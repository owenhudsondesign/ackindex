          ...
          <div className="flex-grow flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                Upgrade to Premium to save and access your conversations
              </p>
              <Link
                href="/pricing"
                className="inline-block px-4 py-2 text-xs font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg transition-all shadow-sm"
              >
                Upgrade
              </Link>
            </div>
        ...
        <div className="flex flex-col h-full p-4">
          ...
          <button
            onClick={() => {
              onNewConversation();
              setIsOpen(false);
              fetchConversations(); // Refresh list when starting new chat
            }}
