...
Use simple, clean HTML with inline styles. Use a warm, community-focused tone.`;
  ...
  try {
    ...
    const htmlContent = buildEmailHtml(parsed.summary, meetings, baseUrl);
...
<head>
  ...
  <title>AckIndex Weekly Summary</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 40px; background-color: #1e3a5f; border-radius: 8px 8px 0 0;">
              <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 600;">
                📋 AckIndex Weekly Summary
              </h1>
              <p style="margin: 8px 0 0 0; color: #94a3b8; font-size: 14px;">
                Your weekly digest of Nantucket town meetings
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 24px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; color: #6b7280; font-size: 12px; text-align: center;">
                You're receiving this because you subscribed to AckIndex weekly updates.<br>
